...
class VidCLIP(nn.Module):
    def __init__(self,
                 clip_config: str,
                 clip_weights: str,
                 clip_vision_additional_config: dict,):
        super(VidCLIP, self).__init__()

        clip_vision_additional_config = Namespace(**clip_vision_additional_config)

        clipconfig = CLIPConfig.from_pretrained(clip_config)
        ...
        self.clipmodel = CLIPModel.from_pretrained(clip_weights, config=clipconfig)
